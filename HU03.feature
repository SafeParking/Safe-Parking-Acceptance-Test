...
Cuando el usuario que busca un estacionamiento libre encuentra una plataforma intuitiva lo que le permite realizar el pago de manera exitosa
Entonces la aplicación despliega una ventana con el mensaje <mensaje_confirmacion> que indica la confirmación exitosa del pago realizado.
...
Dado el usuario que busca un estacionamiento libre se encuentra en la sección de <Transacciones y pagos>
Cuando el usuario que busca un estacionamiento libre encuentra una plataforma no intuitiva lo que le impide ingresar el tipo de pago de su preferencia y credenciales de pago para realizar el pago de manera exitosa
